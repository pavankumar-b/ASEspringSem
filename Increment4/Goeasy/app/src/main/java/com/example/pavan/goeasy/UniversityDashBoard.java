    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UnivDas.putExtra("url","file:///android_asset/index.html");
        ...
        view3.setOnClickListener(new View.OnClickListener() {
                                     ...
                                     {
                                         Intent UnivDas = new Intent(UniversityDashBoard.this,UnivWebPage.class);
                                         UnivDas.putExtra("url","file:///android_asset/cour.html");
                                         startActivity(UnivDas);
                                     }
                                 }
        );
        ...
        view4.setOnClickListener(new View.OnClickListener() {
                                     ...
                                     public void onClick(View v)
                                     {
                                         Intent UnivEvent = new Intent(UniversityDashBoard.this,UniversityEvent.class);
                                         //UnivDas.putExtra("url","http://www.umkc.edu/calendar/");
                                         startActivity(UnivEvent);
                                     }
                                 }
        );
        ...
        view5.setOnClickListener(new View.OnClickListener() {
                                     ...
                                     public void onClick(View v)
                                     {
                                         Intent UnivDas = new Intent(UniversityDashBoard.this,UnivSports.class);
        ...
        view6.setOnClickListener(new View.OnClickListener() {
                                     ...
                                     public void onClick(View v)
                                     {
                                         Intent UnivDas = new Intent(UniversityDashBoard.this,UniversityTransportation.class);
                                         //UnivDas.putExtra("url","http://jsfiddle.net/LakshmiPriyanka/qLyn9naw/9//");
