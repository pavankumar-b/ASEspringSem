...
public class LoginActivity extends PlusBaseActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //onclick of register button save the user details
    ...
    public void register(){
        ...
        try {
            UserRegisterTask task1 = (UserRegisterTask) new UserRegisterTask().execute(email, password);
            register = task1.get();
        }
        catch(Exception ex)
        {
   ...
   /* public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
                       ...
                       */
                        ...
                        try {
                            ...
                            if(!passwd.equals(jsonObject.getString("pwd"))){
                                rtr=false;
                                mPasswordView.setError(getString(R.string.error_invalid_password));
                                Intent errorPwd = new Intent(LoginActivity.this, WrongPassword.class);
    ...
    public class UserRegisterTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... details) {
            ...
            String passwd=details[1];
            email=email.substring(0,email.length()-4);
            String url="http://10.0.2.2:56120/Service1.svc/Signup/"+email+","+passwd;
            Boolean rtr=true;
            StringBuilder stringBuilder = new StringBuilder();
            HttpClient httpClient = new DefaultHttpClient();
            HttpGet httpGet = new HttpGet(url);
            try {
                ...
                if (statusCode == 200) {
                                ...
                                Intent register = new Intent(LoginActivity.this, RegisterComplete.class);
                                //home.putExtra("email", email);
